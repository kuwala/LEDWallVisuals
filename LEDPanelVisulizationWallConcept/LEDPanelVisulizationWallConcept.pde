...
int tohokuTime = 18000;
int northRidgeTime = 24000;
...
void setup() {
  ...
  tohokuGraph = new SpringGraph(tohokuBars, tohokuData, tohokuTime);
  northRidgeGraph = new SpringGraph(northRidgeBars, northRidgeData, northRidgeTime);
